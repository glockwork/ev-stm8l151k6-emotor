/**
  ******************************************************************************
  * @file    COMP/COMP2_AnalogVoltageMonitoring/stm8l15x_it.c
...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
extern __IO uint16_t ADCVal;
extern __IO uint8_t State;
uint16_t VrefintVoltage = 1513; /* typical value of VREFINT is 1.22 V --> 1.22 * 4095 / 3.3 = 1513 */
...
INTERRUPT_HANDLER(ADC1_COMP_IRQHandler, 18)
{
  ...
  */
  ...
  {
    /* Check if the measured value is under the threshold VREFINT */
    if (ADC_GetConversionValue(ADC1) < VrefintVoltage)
    {
      State = STATE_UNDER_THRESHOLD;
    }
  }

  else if (COMP_GetFlagStatus(COMP_Selection_COMP2) != RESET)
  {
