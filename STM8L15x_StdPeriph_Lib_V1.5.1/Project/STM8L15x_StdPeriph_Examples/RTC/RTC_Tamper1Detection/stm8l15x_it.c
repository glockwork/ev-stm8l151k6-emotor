/**
  ******************************************************************************
  * @file    RTC/RTC_Tamper1Detection/stm8l15x_it.c
...
/* Private variables ---------------------------------------------------------*/
/* Public variables -----------------------------------------------------------*/
extern __IO uint8_t LCDTamperTime[];
extern CONST uint8_t RTC_TampFilter[];
extern __IO uint8_t TampFilterIndex;
...
INTERRUPT_HANDLER(EXTI6_IRQHandler, 14)
{
  if (STM_EVAL_PBGetState(BUTTON_KEY) == RESET)
  {
    STM_EVAL_LEDOn(LED1);
    Tamper_DelayShow(TampFilterIndex);
    Time_Show(LCD_LINE2, SHOW_POINT1 );
