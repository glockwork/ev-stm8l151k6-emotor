...
// file Name: D:\Temp\ST_MCU_Codes\LEV_G2_STM8L151K6_2_v2\IAR_project\..\Source_Codes\Config_Info\Different_Rom_Versions\UserDefine_Demeter_B215_36100_S_10S4P3LED_SDI26H_COM_SW1_Asleep_Test_V10.h
// 
/////////////////////////////////////////////////////////////////////////// 
#define ParsingFileName     "UserDefine_Demeter_B215_36100_S_10S4P3LED_SDI26H_COM_SW1_Asleep_Test_V10.h"
...
#define G_TH1_UTP_TIMES_RECORD_EEPROM_Offset                        84    // 0x54
#define G_TH2_UTP_TIMES_RECORD_EEPROM_Offset                        86    // 0x56
...
#define RESERVED_FOR_OFFSET2_Offset                                 96    // 0x60
#define System_Control_Bit_EEPROM_Offset                            98    // 0x62
#define RESERVED_FOR_OFFSET1_Offset                                 99    // 0x63
...
#define CELL_OV_VOLTAGE_FOR_SOC_Offset                              180   // 0xB4
#define CELL_UV_VOLTAGE_FOR_SOC_Offset                              182   // 0xB6
...
#define RESERVED_NoUsed__User_Define_FOR_OFFSET1_Offset             294   // 0x126
...
#define CHG_OVER_VOLTAGE_HOURS_TIMES_RECORD_EEPROM_Offset           302   // 0x12E
...
#define CHARGING_IN_HIGH_TEMP_HOURS_TIMES_RECORD_EEPROM_Offset      308   // 0x134
#define CHARGING_IN_LOW_TEMP_HOURS_TIMES_RECORD_EEPROM_Offset       310   // 0x136
...
#define EEPROM_END_DATA_POSITION_Offset                             340   // 0x154
// 
/////////////////////////////////////////////////////////////////////////// 
// 
// Data Var Point
...
#define G_TH1_UTP_TIMES_RECORD_EEPROM                               *((unsigned int *)(CONFIG_SEGMENT + G_TH1_UTP_TIMES_RECORD_EEPROM_Offset ))
#define G_TH2_UTP_TIMES_RECORD_EEPROM                               *((unsigned int *)(CONFIG_SEGMENT + G_TH2_UTP_TIMES_RECORD_EEPROM_Offset ))
...
#define RESERVED_FOR_OFFSET2                                        *((unsigned int *)(CONFIG_SEGMENT + RESERVED_FOR_OFFSET2_Offset ))
...
#define CELL_OV_VOLTAGE_FOR_SOC                                     *((unsigned int *)(CONFIG_SEGMENT + CELL_OV_VOLTAGE_FOR_SOC_Offset ))
#define CELL_UV_VOLTAGE_FOR_SOC                                     *((unsigned int *)(CONFIG_SEGMENT + CELL_UV_VOLTAGE_FOR_SOC_Offset ))
...
#define RESERVED_NoUsed__User_Define_FOR_OFFSET1                    *((unsigned int *)(CONFIG_SEGMENT + RESERVED_NoUsed__User_Define_FOR_OFFSET1_Offset ))
...
#define CHG_OVER_VOLTAGE_HOURS_TIMES_RECORD_EEPROM                  *((unsigned int *)(CONFIG_SEGMENT + CHG_OVER_VOLTAGE_HOURS_TIMES_RECORD_EEPROM_Offset ))
...
#define CHARGING_IN_HIGH_TEMP_HOURS_TIMES_RECORD_EEPROM             *((unsigned int *)(CONFIG_SEGMENT + CHARGING_IN_HIGH_TEMP_HOURS_TIMES_RECORD_EEPROM_Offset ))
#define CHARGING_IN_LOW_TEMP_HOURS_TIMES_RECORD_EEPROM              *((unsigned int *)(CONFIG_SEGMENT + CHARGING_IN_LOW_TEMP_HOURS_TIMES_RECORD_EEPROM_Offset ))
...
//  #define  _ee_uchar_EEPROM_VERSION                                                                             10 // 1 bytes //only for EEPROM values changing
...
//  #define  _ee_uint_CELL_OV_VOLTAGE_FOR_SOC                                                                     4240 //mv
//  #define  _ee_uint_CELL_UV_VOLTAGE_FOR_SOC                                                                     2800 //mv
...
//  #define  _ee_uint_CAPACITY_DIFFERENCE_VALUES                                                                  10 // % ; 2bytes;
...
// Var_uint       =  G_TH1_UTP_TIMES_RECORD_EEPROM;
// Var_uint       =  G_TH2_UTP_TIMES_RECORD_EEPROM;
...
// Var_uint       =  RESERVED_FOR_OFFSET2;
// Var_uchar      =  System_Control_Bit_EEPROM;
// Var_uchar      =  RESERVED_FOR_OFFSET1;
// Var_uchar      =  VERSION;
...
// Var_uint       =  CELL_OV_VOLTAGE_FOR_SOC;
// Var_uint       =  CELL_UV_VOLTAGE_FOR_SOC;
...
// Var_uint       =  RESERVED_NoUsed__User_Define_FOR_OFFSET1;
...
// Var_uint       =  CHG_OVER_VOLTAGE_HOURS_TIMES_RECORD_EEPROM;
// Var_uint       =  OVER_LOADING_MINUTES_TIMES_RECORD_EEPROM;
// Var_uint       =  FASTER_CHARGING_MINUTES_TIMES_RECORD_EEPROM;
// Var_uint       =  CHARGING_IN_HIGH_TEMP_HOURS_TIMES_RECORD_EEPROM;
// Var_uint       =  CHARGING_IN_LOW_TEMP_HOURS_TIMES_RECORD_EEPROM;
