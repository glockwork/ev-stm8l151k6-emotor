...
//#define MANUFACTURE_DATE_DAY    17
...
////////////////////////////////////////////////////////////////
// CHG_OP_Gain             620.0f
// _CHG_mA_to_ADC_factor_    0.461730909f   ==> (Rsense_mR * CHG_OP_Gain / ADC_Step / 1000)==>小數點6位
// CHG_OP_ADC_OFFSET         (signed char)0    //實際值-理論值
////////////////////////////////////////////////////////////////
// DSG_OP_Gain   82.0f
// _DSG_mA_to_ADC_factor_     0.061067636f  ==> (Rsense_mR * DSG_OP_Gain/ADC_Step/1000)==>小數點6位
...
//////////////////////////////////////////////////////////////////////////////////
//for one cycle count
// 16p * 2600mah * 0.8 = 33280 mah * _CHG_mA_to_ADC_factor_ = 15366 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 (per 500ms)
// 15366 ADC * 7200 = 110635200 ADC
...
// _VBAT_mV_To_ADC_Factor_      0.046590253f
...
//#define Dynamic_UVP_ADC_BATTERY_Vol_TH4                     2311      // 49.6V(cell:3.1); unit: 1mV; UVP > Dynamic_UVP_ADC_TEMP_TH3
...
// status5 : light led4 ==>    under and include DSG_CAPACITY_DISPLAY_TH_5. and bigger than DSG_CAPACITY_DISPLAY_TH_4.
// status6 : light led5 ==>    bigger than DSG_CAPACITY_DISPLAY_TH_5.
...
//////////////////////////////////////////////////////////////////////////
// for 5 LEDs CHG display with 6 status
// 6 status :
...
// status4 : led4 Breathing ==>    under and include CHG_CAPACITY_DISPLAY_TH_4. and bigger than CHG_CAPACITY_DISPLAY_TH_3.
// status5 : led5 Breathing ==>    bigger than CHG_CAPACITY_DISPLAY_TH_4 without Tape current.
// status6 : 5 leds light on ==>    bigger than CHG_CAPACITY_DISPLAY_TH_4 and CHG Current under Tape current.
...
// 20.8Ah八並聯,  DSG  Current Th
//Current-10.4Ah,4P:  <=10.8A,    10.8~13.6A,   13.6~18.8A,   18.8~24.0A,  >24A, TBD: 30.0A, TBD: > 34.8A
