...
#define _ee_str_CELL_TYPE                       "SDI 22FM"
...
////////////////////////////////////////////////////////////////
// DSG_OP_Gain   82.0f
// _DSG_mA_to_ADC_factor_     0.138790083f  ==> (Rsense_mR * DSG_OP_Gain/ADC_Step/1000)==>小數點6位
...
//////////////////////////////////////////////////////////////////////////////////
//for one cycle count
// 4p * 2200mah * 0.8 = 7040 mah * _CHG_mA_to_ADC_factor_ = 2621 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 (per 500ms)
// 2621 ADC * 7200 = 18871200 ADC
#define _ee_ulong_ADC_AccQ_FOR_CHG_TH           18871200       //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
...
// 4p * 2200mah * 0.8 = 7040 mah * _DSG_mA_to_ADC_factor_ = 977 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 times(per 500ms)
// 977 ADC * 7200 = 7034400 ADC
#define _ee_ulong_ADC_AccQ_FOR_DSG_TH           7034400       //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
//////////////////////////////////////////////////////////////////////////////////
...
#define _ee_str_PROJECT_NAME                    "Ares_HM_36088_C"
...
#define _ee_uint_DESIGN_CAPACITY_mAH                        8800    //mAH,
#define _ee_uint_Last_Record_FCC_mAh_RECORD_EEPROM          8800    //mAH,

#define _ee_uint_REAL_FCC_UPDATE_TIMES_RECORD_EEPROM        0
#define _ee_uint_REAL_FCC_mAH_RECORD_EEPROM                 8800    //mAH,
