...
//////////////////////////////////////////////////////////////////////////////////
//for one cycle count
// 4p * 2600mah * 0.8 = 8320 mah * _CHG_mA_to_ADC_factor_ = 3098 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 (per 500ms)
// 3098 ADC * 7200 = 22305600 ADC
...
#define _ee_str_PROJECT_NAME                    "Ares_SX_YJ_36104_D"
