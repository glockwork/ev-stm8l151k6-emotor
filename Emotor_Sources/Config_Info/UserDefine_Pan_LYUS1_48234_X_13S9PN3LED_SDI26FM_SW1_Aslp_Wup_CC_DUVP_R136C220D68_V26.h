...
#define _ee_float_DSG_mA_To_ADC_Factor          0.115263471f        // 4 bytes;
...
//#define MANUFACTURE_DATE_DAY    19
#define _ee_uint_MANUFACTURE_DATE               17587   //(MANUFACTURE_DATE_YEAR - 1980) * 512 + MANUFACTURE_DATE_MONTH * 32 + MANUFACTURE_DATE_DAY  // 2 bytes
...
////////////////////////////////////////////////////////////////
// CHG_OP_Gain             220.0f
// _CHG_mA_to_ADC_factor_    0.372363636f   ==> (Rsense_mR * CHG_OP_Gain / ADC_Step / 1000)==>小數點6位
// CHG_OP_ADC_OFFSET         (signed char)0    //實際值-理論值
////////////////////////////////////////////////////////////////
// DSG_OP_Gain   68.1f
// _DSG_mA_to_ADC_factor_     0.115263471f  ==> (Rsense_mR * DSG_OP_Gain/ADC_Step/1000)==>小數點6位
// DSG_OP_ADC_OFFSET         (signed char)0    //實際值-理論值
// 理論值 = 實際值 - Offset
////////////////////////////////////////////////////////////////////////////////
//(無條件進位==> 會比實際值還大一點)
//(使用四捨五入)
#define _ee_uint_ADC_CURRENT_DETECT_FOR_DSG_STATUS       14       //120mA; unit: mA; 2bytes; if current > the define, in discharging status
#define _ee_uint_ADC_CURRENT_DETECT_FOR_CHG_STATUS       45       //120mA; unit: mA; 2bytes; if current > the define, in charging status

#define _ee_uint_ADC_DOC_PROTECTION                      5763    // 50A; unit: 1mA; (OVER) discharging current protection is positive
#define _ee_uint_ADC_COC_PROTECTION                      1676     // 4.5A; unit: 1mA; charging current protection
#define _ee_uint_ADC_DSG_HIGH_CURRENT_DETECT             922     // 8000mA; 2bytes; for switch High/Low OT Protection
#define _ee_uint_ADC_CHG_CHARGER_TAPE_CURRENT            559      // 1500mA; 2bytes;
//////////////////////////////////////////////////////////////////////////////////
// CHG for one cycle count
// 9p * 2600mah * 0.8 = 18720 mah * _CHG_mA_to_ADC_factor_ = 6971 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 (per 500ms)
// 6971 ADC * 7200 = 50191200 ADC
#define _ee_ulong_ADC_AccQ_FOR_CHG_TH           50191200       //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
...
// 9p * 2600mah * 0.8 = 18720 mah * _DSG_mA_to_ADC_factor_ = 2158 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 times(per 500ms)
// 2158 ADC * 7200 = 15537600 ADC
#define _ee_ulong_ADC_AccQ_FOR_DSG_TH           15537600       //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
//////////////////////////////////////////////////////////////////////////////////
...
#define RECORDING_ADC_DSG_OVER_CURRENT_TH                   1729      //15A=15000mA; unit: mA; check > discharging TH current for recording
// org faster charging current set as 25000mA
// for high faster charging current set as 4500mA
#define RECORDING_ADC_CHG_FASTER_CHARGING_CURRENT_TH        1676      //4500mA; unit: mA; check > charging TH current for detecting faster charging and recording
...
// 13.0Ah五並聯,  DSG  Current Th
//Current-23.4h,9P    <= 12.06A    12.06~14.94A    14.94~21.06A   21.06~25.2A  >25.2.0A   TBD: 33.48A      TBD: >45A
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH1_     1390     // <= 12060 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH2_     1722     // <= 14940 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH3_     2427     // <= 21060 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH4_     2905     // <= 25200 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH5_     3859     // <= 33480 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH6_     5187     // <= 45000 mA; 2bytes;
//=====================================================================================================================
//=====================================================================================================================
