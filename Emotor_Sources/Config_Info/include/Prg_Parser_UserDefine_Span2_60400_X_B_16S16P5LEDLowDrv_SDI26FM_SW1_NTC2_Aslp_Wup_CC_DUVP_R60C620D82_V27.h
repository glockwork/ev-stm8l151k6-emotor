...
// file Name: D:\Temp\ST_MCU_Codes\EV_STM8L151K6_Emotor\IAR_project\..\Emotor_Sources\Config_Info\UserDefine_Span2_60400_X_B_16S16P5LEDLowDrv_SDI26FM_SW1_NTC2_Aslp_Wup_CC_DUVP_R60C620D82_V27.h
// 
/////////////////////////////////////////////////////////////////////////// 
#define ParsingFileName               "UserDefine_Span2_60400_X_B_16S16P5LEDLowDrv_SDI26FM_SW1_NTC2_Aslp_Wup_CC_DUVP_R60C620D82_V27.h"
#define ParsingDate                   __DATE__
#define ParsingTime                   __TIME__
#define ParsingProjectName            "Span2_60400_X_B"
...
// 
/////////////////////////////////////////////////////////////////////////// 
#define  RECORDING_ADC_OVER_VOLTAGE_TH                                 3138       //67.36V(cell:4.21); for 16S Cell = 57V; unit: mV; check charging > over voltag for a long time
#define  RECORDING_ADC_DSG_OVER_CURRENT_1                              611        //10A=10000mA; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_DSG_OVER_CURRENT_2                              916        //15A=15000mA; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_DSG_OVER_CURRENT_3                              1221       //20A=20000mA; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_DSG_OVER_CURRENT_4                              1527       //25A=25000mA; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_DSG_OVER_CURRENT_5                              1832       //30A=30000mA; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_DSG_OVER_CURRENT_6                              2137       //35A=35000mA; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_DSG_OVER_CURRENT_TH                             1832       //30A; unit: mA; check > discharging TH current for recording
#define  RECORDING_ADC_CHG_FASTER_CHARGING_CURRENT_TH                  2309       //5000mA; unit: mA; check > charging TH current for detecting faster charging and recording
...
#define  Enter_Auto_Sleeping_ADC_Vol_Condition                         2982       // 64V(cell:4.0); unit: mV; for 16S Cell = 57V
...
#define  Dynamic_UVP_ADC_BATTERY_Vol_TH1                               2087       // 44.8V(cell:2.8); unit: 1mV; UVP < Dynamic_UVP_ADC_TEMP_TH1
#define  Dynamic_UVP_ADC_BATTERY_Vol_TH2                               2162       // 46.4V(cell:2.9); unit: 1mV; Dynamic_UVP_ADC_TEMP_TH1 <= UVP < Dynamic_UVP_ADC_TEMP_TH2
#define  Dynamic_UVP_ADC_BATTERY_Vol_TH3                               2236       // 48V(cell:3.0); unit: 1mV; Dynamic_UVP_ADC_TEMP_TH2 <= UVP < Dynamic_UVP_ADC_TEMP_TH3
#define  Dynamic_UVP_ADC_BATTERY_Vol_TH4                               2236       // 48V(cell:3.0); unit: 1mV; UVP > Dynamic_UVP_ADC_TEMP_TH3
...
#define DSG_CAPACITY_DISPLAY_TH_5_Offset                            192   // 0xC0
...
#define CHG_CAPACITY_DISPLAY_TH_4_Offset                            200   // 0xC8
...
#define RECORDING_ADC_DSG_OVER_CURRENT_1_6SEC_EEPROM_Offset         396   // 0x18C
#define RECORDING_ADC_DSG_OVER_CURRENT_2_6SEC_EEPROM_Offset         400   // 0x190
#define RECORDING_ADC_DSG_OVER_CURRENT_3_6SEC_EEPROM_Offset         404   // 0x194
#define RECORDING_ADC_DSG_OVER_CURRENT_4_6SEC_EEPROM_Offset         408   // 0x198
#define RECORDING_ADC_DSG_OVER_CURRENT_5_6SEC_EEPROM_Offset         412   // 0x19C
#define RECORDING_ADC_DSG_OVER_CURRENT_6_6SEC_EEPROM_Offset         416   // 0x1A0
#define EEPROM_END_DATA_POSITION_Offset                             420   // 0x1A4
#define EEPROM_PN_INFO_START_DATA_POSITION_Offset                   421   // 0x1A5
#define PN_DAK_NAME_MAX_LENGTH_Offset                               422   // 0x1A6
#define PN_DAK_NAME_Offset                                          423   // 0x1A7
#define PN_85K_NAME_MAX_LENGTH_Offset                               447   // 0x1BF
#define PN_85K_NAME_Offset                                          448   // 0x1C0
#define Cell_PN_NAME_MAX_LENGTH_Offset                              472   // 0x1D8
#define Cell_PN_NAME_Offset                                         473   // 0x1D9
#define EEPROM_PN_INFO_END_DATA_POSITION_Offset                     497   // 0x1F1
// 
/////////////////////////////////////////////////////////////////////////// 
// 
// Data Var Point
...
#define DSG_CAPACITY_DISPLAY_TH_5                                   *((unsigned int *)(CONFIG_SEGMENT + DSG_CAPACITY_DISPLAY_TH_5_Offset ))
...
#define CHG_CAPACITY_DISPLAY_TH_4                                   *((unsigned int *)(CONFIG_SEGMENT + CHG_CAPACITY_DISPLAY_TH_4_Offset ))
...
#define RECORDING_ADC_DSG_OVER_CURRENT_1_6SEC_EEPROM                *((unsigned long *)(CONFIG_SEGMENT + RECORDING_ADC_DSG_OVER_CURRENT_1_6SEC_EEPROM_Offset ))
#define RECORDING_ADC_DSG_OVER_CURRENT_2_6SEC_EEPROM                *((unsigned long *)(CONFIG_SEGMENT + RECORDING_ADC_DSG_OVER_CURRENT_2_6SEC_EEPROM_Offset ))
#define RECORDING_ADC_DSG_OVER_CURRENT_3_6SEC_EEPROM                *((unsigned long *)(CONFIG_SEGMENT + RECORDING_ADC_DSG_OVER_CURRENT_3_6SEC_EEPROM_Offset ))
#define RECORDING_ADC_DSG_OVER_CURRENT_4_6SEC_EEPROM                *((unsigned long *)(CONFIG_SEGMENT + RECORDING_ADC_DSG_OVER_CURRENT_4_6SEC_EEPROM_Offset ))
#define RECORDING_ADC_DSG_OVER_CURRENT_5_6SEC_EEPROM                *((unsigned long *)(CONFIG_SEGMENT + RECORDING_ADC_DSG_OVER_CURRENT_5_6SEC_EEPROM_Offset ))
#define RECORDING_ADC_DSG_OVER_CURRENT_6_6SEC_EEPROM                *((unsigned long *)(CONFIG_SEGMENT + RECORDING_ADC_DSG_OVER_CURRENT_6_6SEC_EEPROM_Offset ))
...
//  #define  _ee_float_CHG_mA_To_ADC_Factor                                                                       0.461730909f // 4 bytes;
//  #define  _ee_float_DSG_mA_To_ADC_Factor                                                                       0.061067636f // 4 bytes;
//  #define  _ee_float_VBAT_mV_To_ADC_Factor                                                                      0.046590253f // 4 bytes;
...
//  #define  _ee_uint_R_Sense_10u_ohm                                                                             60 //2 bytes; 60 * 10u ohm = 0.6 m-ohm
...
//  #define  _ee_uchar_EEPROM_VERSION                                                                             27 // 1 bytes //only for EEPROM values changing
...
//  #define  _ee_uchar_NUMBER_OF_PARALLEL_CELLS                                                                   16 // 1 bytes
//  #define  _ee_uchar_NUMBER_OF_SERIES_CELLS                                                                     16 // 1 bytes
//  #define  _ee_uint_MANUFACTURE_DATE                                                                            17617 //(MANUFACTURE_DATE_YEAR - 1980) * 512 + MANUFACTURE_DATE_MONTH * 32 + MANUFACTURE_DATE_DAY // 2 bytes
...
//  #define  _ee_uint_ADC_CURRENT_DETECT_FOR_DSG_STATUS                                                           17 //278mA; unit: mA; 2bytes; if current > the define, in discharging status
//  #define  _ee_uint_ADC_CURRENT_DETECT_FOR_CHG_STATUS                                                           55 //120mA; unit: mA; 2bytes; if current > the define, in charging status
//  #define  _ee_uint_ADC_DOC_PROTECTION                                                                          2443 // 40A-10sec; unit: 1mA; (OVER) discharging current protection is positive
//  #define  _ee_uint_ADC_COC_PROTECTION                                                                          3694 // 8.0A; unit: 1mA; charging current protection
//  #define  _ee_uint_ADC_DSG_HIGH_CURRENT_DETECT                                                                 4226 //disable; 40000mA; 2bytes; for switch High/Low OT Protection
//  #define  _ee_uint_ADC_CHG_CHARGER_TAPE_CURRENT                                                                693 // 1500mA; 2bytes;
//  #define  _ee_ulong_ADC_AccQ_FOR_CHG_TH                                                                        110635200 //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
...
//  #define  _ee_uint_ADC_BATTERY_OV_PROTECTION                                                                   3161 // 67.84V(cell:4.24); unit: 1mV; 2bytes; 2nd level BATTERY OV PROTECTION
//  #define  _ee_uint_ADC_BATTERY_OV_RELEASE                                                                      3094 // 66.4V(cell:4.15); unit: 1mV; 2bytes; 2nd level BATTERY OV RELEASE
//  #define  _ee_uint_ADC_BATTERY_UV_PROTECTION                                                                   2087 // 44.8V(cell:2.8); unit: 1mV; 2bytes; 2nd level BATTERY UV PROTECTION
//  #define  _ee_uint_ADC_BATTERY_UV_RELEASE                                                                      2497 // 53.6V(cell:3.35);For Delay reach Vol while UVP ; (org) 32V(cell:3.2); unit: 1mV; 2bytes; 2nd level BATTERY UV RELEASE
//  #define  _ee_uint_ADC_DSG_OT_HIGH_PROTECTION                                                                  634 //unit: 77 Celcius; mV;Over temperature protection for discharging(High current)
//  #define  _ee_uint_ADC_DSG_OT_HIGH_RELEASE                                                                     846 //unit: 65 Celcius; mV; Over temperature release for discharging(High current)
//  #define  _ee_uint_ADC_DSG_OT_LOW_PROTECTION                                                                   634 //unit: 77 Celcius; mV; Over temperature protection for discharging(Low current)
...
//  #define  _ee_ulong_ADC_AccQ_FOR_DSG_TH                                                                        14630400 //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
//  #define  _ee_uint_DSG_CAPACITY_DISPLAY_TH_1                                                                   18
//  #define  _ee_uint_DSG_CAPACITY_DISPLAY_TH_2                                                                   36
//  #define  _ee_uint_DSG_CAPACITY_DISPLAY_TH_3                                                                   54
//  #define  _ee_uint_DSG_CAPACITY_DISPLAY_TH_4                                                                   72
//  #define  _ee_uint_DSG_CAPACITY_DISPLAY_TH_5                                                                   90
//  #define  _ee_uint_CHG_CAPACITY_DISPLAY_TH_1                                                                   16
//  #define  _ee_uint_CHG_CAPACITY_DISPLAY_TH_2                                                                   37
//  #define  _ee_uint_CHG_CAPACITY_DISPLAY_TH_3                                                                   58
//  #define  _ee_uint_CHG_CAPACITY_DISPLAY_TH_4                                                                   79
...
//  #define  _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH1_                                                      660 // <= 10800mA; 2bytes;
//  #define  _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH2_                                                      831 // <= 13600mA; 2bytes;
//  #define  _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH3_                                                      1148 // <= 18800mA; 2bytes;
//  #define  _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH4_                                                      1466 // <= 24000mA; 2bytes;
//  #define  _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH5_                                                      1832 // <= 30000mA; 2bytes;
//  #define  _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH6_                                                      2125 // <= 34800mA; 2bytes;
...
//  #define  _ee_str_PROJECT_NAME                                                                                 "Span2_60400_X_B"
...
//  #define  _ee_uint_DESIGN_CAPACITY_mAH                                                                         40000 //mAH,
//  #define  _ee_uint_Last_Record_FCC_mAh_RECORD_EEPROM                                                           40000 //mAH,
//  #define  _ee_uint_REAL_FCC_UPDATE_TIMES_RECORD_EEPROM                                                         0
//  #define  _ee_uint_REAL_FCC_mAH_RECORD_EEPROM                                                                  40000 //mAH,
...
//  #define  _ee_ulong_RECORDING_ADC_DSG_OVER_CURRENT_1_6SEC_EEPROM                                               0 // record ADC_DSG_OVER_CURRENT 1 : 10 sec
//  #define  _ee_ulong_RECORDING_ADC_DSG_OVER_CURRENT_2_6SEC_EEPROM                                               0 // record ADC_DSG_OVER_CURRENT 2 : 10 sec
//  #define  _ee_ulong_RECORDING_ADC_DSG_OVER_CURRENT_3_6SEC_EEPROM                                               0 // record ADC_DSG_OVER_CURRENT 3 : 10 sec
//  #define  _ee_ulong_RECORDING_ADC_DSG_OVER_CURRENT_4_6SEC_EEPROM                                               0 // record ADC_DSG_OVER_CURRENT 4 : 10 sec
//  #define  _ee_ulong_RECORDING_ADC_DSG_OVER_CURRENT_5_6SEC_EEPROM                                               0 // record ADC_DSG_OVER_CURRENT 5 : 10 sec
//  #define  _ee_ulong_RECORDING_ADC_DSG_OVER_CURRENT_6_6SEC_EEPROM                                               0 // record ADC_DSG_OVER_CURRENT 6 : 10 sec
...
// Var_ulong      =  RECORDING_ADC_DSG_OVER_CURRENT_1_6SEC_EEPROM;
// Var_ulong      =  RECORDING_ADC_DSG_OVER_CURRENT_2_6SEC_EEPROM;
// Var_ulong      =  RECORDING_ADC_DSG_OVER_CURRENT_3_6SEC_EEPROM;
// Var_ulong      =  RECORDING_ADC_DSG_OVER_CURRENT_4_6SEC_EEPROM;
// Var_ulong      =  RECORDING_ADC_DSG_OVER_CURRENT_5_6SEC_EEPROM;
// Var_ulong      =  RECORDING_ADC_DSG_OVER_CURRENT_6_6SEC_EEPROM;
