...
////////////////////////////////////////////////////////////////////////////////
#define _ee_float_CHG_mA_To_ADC_Factor          0.273066667f        // 4 bytes;
#define _ee_float_DSG_mA_To_ADC_Factor          0.084526545f        // 4 bytes;
...
//------------------------------------------------------------------------------------------
#define _ee_uint_R_Sense_10u_ohm                 100    //2 bytes; 115 * 10u ohm = 2.00 m-ohm
...
#define _ee_uchar_NUMBER_OF_PARALLEL_CELLS      9       // 1 bytes
...
////////////////////////////////////////////////////////////////
// CHG_OP_Gain             220.0f
// _CHG_mA_to_ADC_factor_    0.273066667f   ==> (Rsense_mR * CHG_OP_Gain / ADC_Step / 1000)==>小數點6位
// CHG_OP_ADC_OFFSET         (signed char)0    //實際值-理論值
////////////////////////////////////////////////////////////////
// DSG_OP_Gain   68.1f
// _DSG_mA_to_ADC_factor_     0.084526545f  ==> (Rsense_mR * DSG_OP_Gain/ADC_Step/1000)==>小數點6位
// DSG_OP_ADC_OFFSET         (signed char)0    //實際值-理論值
// 理論值 = 實際值 - Offset
////////////////////////////////////////////////////////////////////////////////
//(無條件進位==> 會比實際值還大一點)
//(使用四捨五入)
#define _ee_uint_ADC_CURRENT_DETECT_FOR_DSG_STATUS       14       //166mA; unit: mA; 2bytes; if current > the define, in discharging status
#define _ee_uint_ADC_CURRENT_DETECT_FOR_CHG_STATUS       33       //120mA; unit: mA; 2bytes; if current > the define, in charging status

#define _ee_uint_ADC_DOC_PROTECTION                      4226    // 50A; unit: 1mA; (OVER) discharging current protection is positive
#define _ee_uint_ADC_COC_PROTECTION                      1229     // 4.5A; unit: 1mA; charging current protection
#define _ee_uint_ADC_DSG_HIGH_CURRENT_DETECT             4226     // disable; 8000mA; 2bytes; for switch High/Low OT Protection
#define _ee_uint_ADC_CHG_CHARGER_TAPE_CURRENT            410      // 1500mA; 2bytes;
//////////////////////////////////////////////////////////////////////////////////
// CHG for one cycle count
// 9p * 2600mah * 0.8 = 18720 mah * _CHG_mA_to_ADC_factor_ = 5112 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 (per 500ms)
// 5112 ADC * 7200 = 36806400 ADC
#define _ee_ulong_ADC_AccQ_FOR_CHG_TH           36806400       //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
...
// 理論值 = 實際值 - Offset
////////////////////////////////////////////////////////////////
#define _ee_uint_ADC_BATTERY_OV_PROTECTION             3620 // 55V; unit: 1mV; 2bytes; 2nd level BATTERY OV PROTECTION
#define _ee_uint_ADC_BATTERY_OV_RELEASE                3554 // 54V; unit: 1mV; 2bytes; 2nd level BATTERY OV RELEASE
#define _ee_uint_ADC_BATTERY_UV_PROTECTION             2402 // 36.5V; unit: 1mV; 2bytes; 2nd level BATTERY UV PROTECTION
#define _ee_uint_ADC_BATTERY_UV_RELEASE                2867 // 43.55V;For Delay reach Vol while UVP ; (org) 42V; unit: 1mV; 2bytes; 2nd level BATTERY UV RELEASE
...
// 9p * 2600mah * 0.8 = 18720 mah * _DSG_mA_to_ADC_factor_ = 1582 ADC,
// Accumulating interval time = 500 ms. ==> 1 hour = 3600 second. = 3,600,000 ms = 7200 times(per 500ms)
// 1582 ADC * 7200 = 11390400 ADC
#define _ee_ulong_ADC_AccQ_FOR_DSG_TH           11390400       //one Cycle Count Threshold; //long int => max = 4,294,967,295 = 0xffff ffff ffff ffff
//////////////////////////////////////////////////////////////////////////////////
...
//=====================================================================================================================
#define RECORDING_ADC_DSG_OVER_CURRENT_1                   845      //10A=10000mA; unit: mA; check > discharging TH current for recording
#define RECORDING_ADC_DSG_OVER_CURRENT_2                   1268      //15A=15000mA; unit: mA; check > discharging TH current for recording
#define RECORDING_ADC_DSG_OVER_CURRENT_3                   1691      //20A=20000mA; unit: mA; check > discharging TH current for recording
#define RECORDING_ADC_DSG_OVER_CURRENT_4                   2113      //25A=25000mA; unit: mA; check > discharging TH current for recording
#define RECORDING_ADC_DSG_OVER_CURRENT_5                   2536      //30A=30000mA; unit: mA; check > discharging TH current for recording
#define RECORDING_ADC_DSG_OVER_CURRENT_6                   2958      //35A=35000mA; unit: mA; check > discharging TH current for recording

// org DOC set as 10A, for 9P cell set as 15A
#define RECORDING_ADC_DSG_OVER_CURRENT_TH                   1268      //15A=15000mA; unit: mA; check > discharging TH current for recording
// org faster charging current set as 25000mA
// for high faster charging current set as 4500mA
#define RECORDING_ADC_CHG_FASTER_CHARGING_CURRENT_TH        1229      //4500mA; unit: mA; check > charging TH current for detecting faster charging and recording
...
#define Dynamic_UVP_ADC_BATTERY_Vol_TH1                     2396      // 36.400V(cell:2.8); unit: 1mV; UVP < Dynamic_UVP_ADC_TEMP_TH1
#define Dynamic_UVP_ADC_BATTERY_Vol_TH2                     2481      // 37.700V(cell:2.9); unit: 1mV; Dynamic_UVP_ADC_TEMP_TH1 <= UVP < Dynamic_UVP_ADC_TEMP_TH2
#define Dynamic_UVP_ADC_BATTERY_Vol_TH3                     2567      // 39.000V(cell:3.0); unit: 1mV; Dynamic_UVP_ADC_TEMP_TH2 <= UVP < Dynamic_UVP_ADC_TEMP_TH3
#define Dynamic_UVP_ADC_BATTERY_Vol_TH4                     2567      // 39.000V(cell:3.0); unit: 1mV; UVP > Dynamic_UVP_ADC_TEMP_TH3
//#define Dynamic_UVP_ADC_BATTERY_Vol_TH4                     xxxx      // xxV(cell:3.1); unit: 1mV; UVP > Dynamic_UVP_ADC_TEMP_TH3
...
// Battery for a cell capacity ==> 2600 mAH * 9p
// 23.4Ah九並聯,  DSG  Current Th
//Current-23.4h,9P    <= 12.06A    12.06~14.94A    14.94~21.06A   21.06~25.2A  >25.2.0A   TBD: 33.48A      TBD: >45A
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH1_     1019     // <= 12060 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH2_     1263     // <= 14940 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH3_     1780     // <= 21060 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH4_     2130     // <= 25200 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH5_     2830     // <= 33480 mA; 2bytes;
#define _ee_uint__ADC_DSG_CURRENT_LOOKUP_OCV_TABLE_TH6_     3804     // <= 45000 mA; 2bytes;
//=====================================================================================================================
//=====================================================================================================================
...
#define _ee_str_PROJECT_NAME                    "Pan_LYUS1_48234_X"
...
#define _ee_uint_DESIGN_CAPACITY_mAH                        23400    //mAH,
#define _ee_uint_Last_Record_FCC_mAh_RECORD_EEPROM          23400    //mAH,

#define _ee_uint_REAL_FCC_UPDATE_TIMES_RECORD_EEPROM        0
#define _ee_uint_REAL_FCC_mAH_RECORD_EEPROM                 23400    //mAH,
